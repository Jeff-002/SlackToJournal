...
class SlackUser(BaseModel):
    ...
    display_name_normalized: Optional[str] = Field(default=None, description="Normalized display name")
...
class SlackMessage(BaseModel):
    ...
    user_real_name: Optional[str] = Field(default=None, description="User real name")
